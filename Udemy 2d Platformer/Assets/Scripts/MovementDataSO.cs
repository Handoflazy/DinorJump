...
public class MovementDataSO : ScriptableObject
{
    ...
    [Range(0.01f, 1f)] public float jumpInputBufferTime; //Grace period after pressing jump where a jump will be automatically performed once the requirements (eg. being grounded) are met.
    [Space(20)]
    ...
    private void OnValidate()
    {
        ...
        //Calculate jumpForce using the formula (initialJumpVelocity = gravity * timeToJumpApex)// (  initialJumpVelocity = 2h / timeToJumpApex)
